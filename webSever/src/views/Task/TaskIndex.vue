...
export default {
    setup() {
        ...
        const fetchData_0 = (val) => {
            ...
            axios.get(`http://localhost:8081/selectCheckTask?id=0&taskName=${val}`, { headers })
                .then(response => {
        ...
        const fetchData_1 = (val) => {
            ...
            axios.get(`http://localhost:8081/selectCheckTask?id=1&taskName=${val}`, { headers })
                .then(response => {
        ...
        const deleteTask = (taskId, position, checkTask) => {
            ...
            axios.delete(`http://localhost:8081/tasks?id=${taskId}`, { headers })
                .then(response => {
                    if (checkTask == 0) {
        ...
        const completeTask = (taskId, index) => {
            ...
            axios.put(`http://localhost:8081/tasks?id=${taskId}`, null, { headers })
                .then(response => {
                    // 处理完成成功的逻辑
